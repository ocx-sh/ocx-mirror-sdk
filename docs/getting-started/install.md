...
# dependencies = [
#   "ocx-mirror-sdk @ git+https://github.com/ocx-sh/ocx-mirror-sdk@v0.5.0",
# ]
# ///
...
[tool.uv.sources]
ocx-mirror-sdk = { git = "https://github.com/ocx-sh/ocx-mirror-sdk", tag = "v0.5.0" }
```
...
# requires-python = ">=3.13"
# dependencies = [
#   "ocx-mirror-sdk @ https://github.com/ocx-sh/ocx-mirror-sdk/releases/download/v0.5.0/ocx_mirror_sdk-0.5.0-py3-none-any.whl",
# ]
# ///
```
...
| Source | Tag |
|---|---|
| Latest stable | [`v0.3.0`](https://github.com/ocx-sh/ocx-mirror-sdk/releases/tag/v0.5.0) |
