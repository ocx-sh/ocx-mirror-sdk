...
# requires-python = ">=3.13"
# dependencies = [
#   "ocx-mirror-sdk @ https://github.com/ocx-sh/ocx-mirror-sdk/releases/download/v0.4.0/ocx_mirror_sdk-0.4.0-py3-none-any.whl",
# ]
# ///
```
...
| Source | Tag |
|---|---|
| Latest stable | [`v0.3.0`](https://github.com/ocx-sh/ocx-mirror-sdk/releases/tag/v0.4.0) |
